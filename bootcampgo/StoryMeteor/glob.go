...
// 	patterns := []string{
// 		"h*o", "*lo", "he*", "*", "*ello", "*l*", "h*llo", "h?llo", "he?lo", "?????", "????", "h??l?", "?ello", "h[e]llo", "h[aeiou]llo", "h[!aeiou]llo", "h[aeiou]llo", "h[a-z]llo", "h[a-c]llo", "h[a-zA-Z]llo", "h*l?", "h[aeiou]*o", "h[aeiou]*?", "*[aeiou]lo", "*[aeiou]l?", "*[!aeiou]l?",
// 	}
